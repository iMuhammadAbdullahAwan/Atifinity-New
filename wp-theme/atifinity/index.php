...
<main class="pt-36 sm:pt-40 lg:pt-44 pb-24 sm:pb-32">
    <section class="section relative z-10">
        <div class="container-x">
            <header class="mb-12">
                <h1 class="section-title data-reveal-text">Blog</h1>
                <p class="section-lede mt-6 max-w-2xl text-ink-muted data-reveal">Latest news, articles, and insights.</p>
            </header>
            ...
            <?php else : ?>
                <p class="text-ink-muted text-small"><?php esc_html_e('No posts found.', 'atifinity'); ?></p>
            <?php endif; ?>
        </div>
    </section>
</main>
